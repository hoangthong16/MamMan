...
public class GioHangFragment extends Fragment {
    ...
    private View view;
    private FrameLayout fragment_gio_hang;
    private float tongtien=0;
    private TextView hienthitongten;
    private Button btncleargiohang;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment_gio_hang =(FrameLayout) view.findViewById(R.id.fragment_gio_hang);
        hienthitongten =(TextView) view.findViewById(R.id.hienthitongten);
        btncleargiohang =(Button)view.findViewById(R.id.btncleargiohang);



       for (GioHang gioHang : HomeActivity.listgiohang){
           tongtien += gioHang.getGiasp() *gioHang.getSoluongsp();
       }


        hienthitongten.setText("Tổng tiền: " + tongtien);
       if(tongtien==0) {
            view.setVisibility(View.INVISIBLE);
       }

        fragment_gio_hang.setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        btncleargiohang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
